...
const MEMORY_CHECK_INTERVAL_MS = 60000; // 每分钟检查一次
const TIMEOUT_RESET_THRESHOLD_MS = 300000; // 5分钟
const WORKER_INIT_TIMEOUT_MS = 600000; // 600秒超时
const MAX_DETECTION_LENGTH = 64;
