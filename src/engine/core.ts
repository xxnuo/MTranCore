import { BergamotModule, ModelBuffers, TranslationConfig, TranslateOptions, TranslationOptions } from '../interfaces.js';
...
export class TranslationEngine {
  ...
  private _processQueue(): void {
    ...
    try {
      ...
      // Use setTimeout if setImmediate is not available (though in Node it is)
